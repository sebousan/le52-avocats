...
require (
	...
	github.com/hugolify/hugolify-netlify-cms v1.2.0 // indirect
	github.com/hugolify/hugolify-theme v1.4.1 // indirect
	...
	github.com/hugolify/lawyerify-theme v1.0.5 // indirect
