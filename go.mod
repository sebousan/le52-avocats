...
require (
	...
	github.com/hugolify/hugolify-theme v1.4.12 // indirect
	github.com/hugolify/hugolify-theme-persons v1.0.17 // indirect
	github.com/hugolify/hugolify-theme-persons-statutes v1.0.11 // indirect
