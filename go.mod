...
require (
	...
	github.com/hugolify/hugolify-theme-persons-statutes v1.1.12 // indirect
	...
	github.com/uncinq/lawyerify-netlify-cms v1.4.0 // indirect
	github.com/uncinq/lawyerify-theme v1.5.0 // indirect
)
